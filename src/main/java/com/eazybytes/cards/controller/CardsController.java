...
public class CardsController {
    ...
    public ResponseEntity<ResponseDto> updateCardDetails(@Valid @RequestBody CardsDto cardsDto) {
        ...
        return ResponseEntity
                ...
                .body(new ResponseDto(
                        isUpdated ? CardsConstants.STATUS_200 : CardsConstants.STATUS_417,
                        isUpdated ? CardsConstants.MESSAGE_200 : CardsConstants.MESSAGE_417_UPDATE
                ));
    }
    ...
    public ResponseEntity<ResponseDto> deleteCardDetails(@RequestParam @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
        ...
        return ResponseEntity
                ...
                .body(new ResponseDto(
                        isDeleted ? CardsConstants.STATUS_200 : CardsConstants.STATUS_417,
                        isDeleted ? CardsConstants.MESSAGE_200 : CardsConstants.MESSAGE_417_DELETE
                ));
    }
}
